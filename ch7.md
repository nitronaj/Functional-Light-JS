...
Now, this is all conceptual. I'm not literally saying the JS engine uses objects and prototypes. But it's entirely plausible that it _could_ work similarly.
...
**Note:** Accurately and actionably judging performance of a snippet of JS code is a very dodgy affair. We won't get into all the details here, but I urge you to read _You Don't Know JS: Async & Performance_, specifically Chapter 6, "Benchmarking & Tuning", for more details.
